---
title: Installation
description: Get Spry Operational Truth Orchestration tool up and running on your system
icon: Download
index  : 1 
---
...
<Tabs items={['Homebrew', 'Manual', 'Version switching using Homebrew']}>
  ...
  <Tab value="Manual">
    Download the latest release from [GitHub](https://github.com/programmablemd/packages/releases/tag/latest) and replace your existing installation following the same installation steps.
  </Tab>
</Tabs>